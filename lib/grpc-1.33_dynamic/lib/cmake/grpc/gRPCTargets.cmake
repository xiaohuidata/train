...
add_library(gRPC::absl_bad_optional_access SHARED IMPORTED)
...
add_library(gRPC::absl_bad_variant_access SHARED IMPORTED)
...
add_library(gRPC::absl_base SHARED IMPORTED)

set_target_properties(gRPC::absl_base PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_atomic_hook;gRPC::absl_base_internal;gRPC::absl_config;gRPC::absl_core_headers;gRPC::absl_dynamic_annotations;gRPC::absl_log_severity;gRPC::absl_raw_logging_internal;gRPC::absl_spinlock_wait;gRPC::absl_type_traits;Threads::Threads"
)
...
add_library(gRPC::absl_city SHARED IMPORTED)
...
add_library(gRPC::absl_civil_time SHARED IMPORTED)
...
set_target_properties(gRPC::absl_container_memory PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_memory;gRPC::absl_utility"
)

# Create imported target gRPC::absl_cord
add_library(gRPC::absl_cord SHARED IMPORTED)

set_target_properties(gRPC::absl_cord PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_strings_internal;gRPC::absl_base;gRPC::absl_base_internal;gRPC::absl_core_headers;gRPC::absl_endian;gRPC::absl_fixed_array;gRPC::absl_function_ref;gRPC::absl_inlined_vector;gRPC::absl_raw_logging_internal;gRPC::absl_type_traits"
)
...
add_library(gRPC::absl_debugging_internal SHARED IMPORTED)
...
add_library(gRPC::absl_demangle_internal SHARED IMPORTED)
...
add_library(gRPC::absl_dynamic_annotations SHARED IMPORTED)
...
add_library(gRPC::absl_exponential_biased SHARED IMPORTED)
...
set_target_properties(gRPC::absl_fixed_array PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_compressed_tuple;gRPC::absl_algorithm;gRPC::absl_core_headers;gRPC::absl_dynamic_annotations;gRPC::absl_throw_delegate;gRPC::absl_memory"
)
...
add_library(gRPC::absl_graphcycles_internal SHARED IMPORTED)
...
add_library(gRPC::absl_hash SHARED IMPORTED)
...
set_target_properties(gRPC::absl_hash_function_defaults PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_config;gRPC::absl_hash;gRPC::absl_strings"
)
...
add_library(gRPC::absl_hashtablez_sampler SHARED IMPORTED)
...
add_library(gRPC::absl_int128 SHARED IMPORTED)
...
set_target_properties(gRPC::absl_layout PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_core_headers;gRPC::absl_meta;gRPC::absl_strings;gRPC::absl_span;gRPC::absl_utility"
)

# Create imported target gRPC::absl_log_severity
add_library(gRPC::absl_log_severity SHARED IMPORTED)
...
add_library(gRPC::absl_malloc_internal SHARED IMPORTED)
...
add_library(gRPC::absl_raw_hash_set SHARED IMPORTED)
...
add_library(gRPC::absl_raw_logging_internal SHARED IMPORTED)
...
add_library(gRPC::absl_spinlock_wait SHARED IMPORTED)
...
add_library(gRPC::absl_stacktrace SHARED IMPORTED)
...
add_library(gRPC::absl_status SHARED IMPORTED)

set_target_properties(gRPC::absl_status PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_config;gRPC::absl_core_headers;gRPC::absl_raw_logging_internal;gRPC::absl_inlined_vector;gRPC::absl_stacktrace;gRPC::absl_symbolize;gRPC::absl_strings;gRPC::absl_cord;gRPC::absl_str_format;gRPC::absl_optional"
)
...
add_library(gRPC::absl_str_format_internal SHARED IMPORTED)
...
add_library(gRPC::absl_strings SHARED IMPORTED)
...
add_library(gRPC::absl_strings_internal SHARED IMPORTED)
...
add_library(gRPC::absl_symbolize SHARED IMPORTED)

set_target_properties(gRPC::absl_symbolize PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::absl_debugging_internal;gRPC::absl_demangle_internal;gRPC::absl_base;gRPC::absl_config;gRPC::absl_core_headers;gRPC::absl_dynamic_annotations;gRPC::absl_malloc_internal;gRPC::absl_raw_logging_internal"
)

# Create imported target gRPC::absl_synchronization
add_library(gRPC::absl_synchronization SHARED IMPORTED)
...
add_library(gRPC::absl_throw_delegate SHARED IMPORTED)
...
add_library(gRPC::absl_time SHARED IMPORTED)
...
add_library(gRPC::absl_time_zone SHARED IMPORTED)
...
add_library(gRPC::ssl SHARED IMPORTED)

# Create imported target gRPC::crypto
add_library(gRPC::crypto SHARED IMPORTED)
...
set_target_properties(gRPC::gpr PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "dl;rt;m;pthread;gRPC::absl_time;gRPC::absl_synchronization;gRPC::absl_strings;gRPC::absl_str_format;gRPC::absl_memory;gRPC::absl_base"
)
...
set_target_properties(gRPC::grpc PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "gRPC::ssl;gRPC::crypto;gRPC::zlibstatic;gRPC::cares;gRPC::address_sorting;gRPC::re2;gRPC::upb;dl;rt;m;pthread;gRPC::gpr;gRPC::address_sorting;gRPC::upb;gRPC::absl_optional;gRPC::absl_strings;gRPC::absl_status;gRPC::absl_inlined_vector;gRPC::absl_flat_hash_set"
)
